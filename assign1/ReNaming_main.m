function [  ] = ReNaming_main(  )
%COMPRESSION_MAIN Summary of this function goes here
%   Detailed explanation goes here


% parameters goes here
directoryPath = 'D:\report\report3_ProductionTest_700\';
outputDirectory = 'D:\report\report3_ProductionTest_700\';
...
%             A = imresize(A, [200, NaN]);
            imwrite( A, [ outputDirectory '-700px-' fileListing(i).name ] );
%         end
