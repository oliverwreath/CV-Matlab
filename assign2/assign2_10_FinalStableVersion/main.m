...
if flag == 'dn'
    ...
    %% Eigenvalues
    [ cx, cy, rad, MajorColumn, MinorColumn, angleColumn, ReNumber, alpha ] = get_Eigens( imgA, cx, cy, rad, ReNumber );

    %% Result Eclipses Coloumn Array Generating
    show_all_ellipses(imgA_Copy, cy, cx, rad, MajorColumn, MinorColumn, angleColumn, ReNumber, ScaleFactor, alpha);
    %%
